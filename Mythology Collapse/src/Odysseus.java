...
public class Odysseus {
	...
	private static void help() {
		...
		takeAnAnswer(2);
		if(answer==1) {
			if(questionPicker (randValue.nextInt(20)+1)==true) {  //getQuestion prints the question and returns true is the answer is true or false for the opoosite situation 
