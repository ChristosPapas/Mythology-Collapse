package MythologyCollapse;
	...
	public class Odysseus {
		...
		public static void backToMenu() {
			panel.setMessage("<html><br/>Αν θέλεις να ξαναπαίξεις την πίστα του Οδυσσέα και να αλλάξεις τις αποφάσεις σου, πάτησε 1.<br/>"
		...
		private static void lotofagoi() {
			panel.setMessage("<html>Καλωσόρισες στην πίστα του Οδυσσέα!\n<html>");
			panel.setMessage("<html>Μετά την νίκη των Αχαιών στον πόλεμο της Τροίας, ο Οδυσσέας, "
					...
					+ "<br/>των ναυτών πέρα μακριά, στην χώρα των Λωτοφάγων...<br/><br/><br/><html>");
			panel.setMessage("<html>Oι κατάκοποι από τον πόλεμο ναύτες χαροπάλευαν μέρες ολόκληρες με τα κύματα,"
		...
		private static void help() {
			...
			panel.setMessage(s);
			panel.setMessage("<html>Θα βοηθήσεις τον ήρωα να επιβιώσει;\nΑπάντησε:\n1. ΝΑΙ\n2. ΟΧΙ\n<html>");
			answer = Quiz.takeAnAnswer(2);
			...
			if(answer==1) {
				...
				panel.setMessage("<html>\nΟρίστε ένα hint για τη συνέχιση του παιχνιδιού:"
					...
					panel.setMessage("<html><br/>Έχασες, δυστυχώς, την ευκαιρία σου να βοηθήσεις τον ήρωα...<br/>Καλή Τύχη!!<html>");
				}  
			}
		}
		...
		private static void cyclops() {
			panel.setMessage("<html>Μετά την χώρα των λωτοφάγων, οι επεμβάσεις των θεών τους οδήγησαν στην χώρα των Κυκλώπων. <br/><br/>"
		...
		private static void cyclopsGuns(int odGun, int cyGun) {
			...
			panel.setMessage("<html>Όταν οι ναύτες φτάνουν στο νησί, αφελείς ως ήταν κατεβαίνουν στη στεριά και αρχίζουν να περιηγούνται στον ξένο τόπο."
			...
			if(odGun==1 && cyGun==1) {
				panel.setMessage("<html>Αφού ο Οδυσσέας συστήνεται ως 'Kανένας', ο Πολύφημος ψάχνει ανάμεσα στους ναύτες να τον βρει.Όταν οι ναύτες αρνούνται να "
			...
			//	Odysseus's gun is a shield and Cyclops's a magnifying eye
				...
				panel.setMessage("<html>Αφού ο Οδυσσέας συστήνεται ως 'Kανένας', ο Πολύφημος ψάχνει ανάμεσα στους ναύτες να τον βρει. Καθώς οι ναύτες βρίσκονται "
			...
			//	Odysseus's gun is a sling and Cyclops's a magnifying eye
				...
				panel.setMessage("<html>Αφού ο Οδυσσέας συστήνεται ως” Κανένας” ο Πολύφημος ψάχνει ανάμεσα στους ναύτες να τον βρει. Καθώς οι ναύτες βρίσκονται"
		...
		private static void aiolos() {
			...
			//	hero chooses a mysterious skin
				...
				panel.setMessage("<html>Οι ναύτες, ωστόσο, μη γνωρίζοντας το περιεχόμενο του ασκού μπαίνουν στον πειρασμό να τον ανοίξουν.<br/><br/>"
		...
		private static void laistrigones() {
			panel.setMessage("<html>Επόμενη περιπέτεια του Οδυσσέα είναι η χώρα των Λαιστρυγόνων.Οι μυθικοί “κάτοικοι” του νησιού υποδέχονται τους ναύτες με άγριες διαθέσεις:"
					+ "Τεράστιες πέτρες πετάγονται στα πλοία, ενώ κάποιοι από τους συντρόφους αποτελούν το γεύμα των τεράτων...<br/><br/><html>");
			panel.setMessage("<html>Όσο οι νάυτες προσπαθούν να γλιτώσουν από την επίθεση των τεράτων, ένας τεράστιος βράχος εξφενδονίζεται προς το καράβι του Οδυσσέα!"
		...
		private static void toKirki() {
			panel.setMessage("<html>Ο Οδυσσέας και οι ναύτες του καταφέρνουν να γλιτώσουν και κατευθύνονται εν αγνοία τους προς έναν άλλο, ακόμη πιο τρομακτικό προορισμό, το νησί της Κίρκης.<br/>"
			...
			//	the hero has fount the sword but he is in love with Kirki
				...
				panel.setMessage("<html>Η Κίρκη, όντας και η ίδια ένα μαγικό πλάσμα, καταλαβαίνει αμέσως ότι η αντίδραση του άγνωστου νάυτη είναι αποτέλεσμα κάποιου ξορκιού.Έτσι, αποφασίζει να δώσει"
		...
		private static void death() {
			timer.cancel();
			panel.setMessage("<html>Ο Οδυσσέας είναι πλέον νεκρός!Δυστυχώς δεν κατάφερε να ζήσει το 'HAPPY ENDING' των ιστοριών...<br/><br/><html>");		
			backToMenu();
		}
			...
			private static void ithaki() {
				...
				panel.setMessage("<html>Όταν ο Οδυσσέας φτάνει στην Ιθάκη, μαθαίνει ότι η πολύχρονη απουσία του έχει αφήσει εκτεθειμένη την γυναίκα του,<br/>"
			...
			private static void teiresias() {
				panel.setMessage("<html>Επόμενη στάση στο ατέλειωτο ταξίδι ειναι ο Άδης. Εκει συναντάει τον μάντη τειρεσία ο οποίος έχει ένα πολύ σημαντικό χρησμό για την εξέλιξη της ιστορίας.<br/>"
			...
			private static void seirines () {
				panel.setMessage("<html>Μετά τον μάντη Τειρεσία, το καράβι του Οδυσσέα οδηγείται στις Σειρήνες.<br/>"
			...
			private static void skylla() {
				panel.setMessage("<html>Σειρά έχουν η Σκύλλα και η Χάρυβδη, ένα εξακέφαλο τέρας και μια τεράστια ρουφήχτρα,<br/>"
						+ "τις οποίες επιδεικτικά καταφέρνουν να αποφύγουν.<html>");
				if (disease) {
					timer.cancel();
					panel.setMessage("<html>Όταν ο Οδυσσέας φτάνει στη σκύλλα, με μια αριστοτεχνική κίνηση, στοχέυει στο λαιμό και την τραυματίζει θανάσιμα.<br/>"
			...
			private static void ilios () {
				panel.setMessage("<html>Πλέον οι νάυτες πλέουν προοδευτικά προς το νησί του ήλιου. Εκεί οι σύντροφοι πεινασμένοι αναζητούν τροφή στα βόδια του θεού.<br/>"
			...
			private static void kalypso () {
				panel.setMessage("<html>Εκεί ο Οδυσσέας θα ξεχάσει άραγε την πατρίδα και τη γυναίκα του ή θα θελήσει με την βοήθεια της Αθηνάς να επιστρέψει στα πολυαγαπημένα του πρόσωπα ?<br/><br/>"
			...
			private static void faiakes() {
				panel.setMessage("<html>Στο δρόμο για την Ιθάκη, η μοίρα τον στέλνει στο νησί των Φαιάκων.Εκεί αφού οι κάτοικοι του νησιού τον φιλοξενούν, σε μια στιγμή αδυναμίας αποκαλύπτει ότι "
