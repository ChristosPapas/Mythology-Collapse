 ...
 *****************************************************/
	...
	private static void roadChoosing() {
		...
		panel.setMessage("<html> Ποιόν δρόμο τελικά επέλεξε ο Ηρακλής; <br>" 
						+ "1)Της Αρετής. <br>" 
	...
	private static void killingHydra() {
		...
		panel.setMessage("<html> Με ποιόν τρόπο προσπάθησε,λοιπόν, να νικήσει την Λερναία Ύδρα; <br>"
		...
		if (answer == 1) {
			...
			if (answer == 1) {
				panel.setMessage("<html> Ο Ηρακλής προσπαθεί ξανά να βρει κάποιον τρόπο να εξοντώσει την Λερναία Ύδρα. <html>");
			
			} else if (answer == 2) {
				panel.setMessage("<html> Ο Ευρυσθέας του υπενθύμισε γιατί κάνει τους άθλους του και πως έπρεπε να τα καταφέρει.<html>");
				panel.setMessage("<html> Πως έπραξε ο Ηρακλής μετά από αυτήν την υπενθύμιση; <br>"
	...
	private static void pathDigging() {
		...
		panel.setMessage("<html>Ο Ηρακλής πού έσκαψε για να κατευθύνει τα νερά του Πηνειού και του Αλφειού,<br>"
	...
	private static void minotaurFeat() {
		...
		panel.setMessage("<html> Με ποιον τρόπο κατάφερε λοιπόν ο Ηρακλής να ολοκληρώσει τον έβδομο άθλο; <br>"
	...
	private static void dwarfBrothers() {
		...
		if (answer == 1) {
			...
			panel.addMessage("<html> Έπειτα τι έγινε; <br>"
			...
			if (answer == 1) {
				panel.addMessage("<html> Έτσι ο Ηρακλής τους παγίδευσε στη λεοντή του και τους πήγε στον Ευρυσθέα. <html>");
	...
	private static int sthingMissing() {
		panel.addMessage("<html> Τι έκανε για την έλλειψη αυτή που ένιωθε μέσα του; <br>"
	...
	private static void relationKids() {
		...
		if (answer == 1) {
			panel.setMessage("<html> 1)Πεθαίνοντας άφησε ολόκληρη την περιουσία του στην οικογένειά του έχοντας μεταλαμπαδεύσει στα παιδιά του <br>"
			...
			panel.setMessage("<html> 1)Η γυναίκα του τον σκότωσε καθώς αυτή υπολόγιζε μόνο το χρήμα και <br>"
	...
	private static void endingTitles() {
		panel.setMessage("<html> Με αυτόν τον τρόπο και μετά από πολλά χρόνια τελείωσε η ζωή του μυθικού <br>"
						...
						+ "<br>"
						+ "<br>		THE END <html>");
		panel.setMessage("<html> Επιμέλεια και Παραγωγή: Mythology Collapse <html>");
	}
}
